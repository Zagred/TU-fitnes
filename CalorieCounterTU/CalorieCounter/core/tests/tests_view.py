...
class AddPlanForTheDayTest(TestCase):
    ...
    def test_daily_data__expect_meal_added(self):
        ...
        self.assertEqual(self.plan.calories, daily_data.calories_eaten)
        self.assertEqual(self.plan.protein_grams, daily_data.proteins_grams_per_day)
        self.assertEqual(self.plan.fats_grams, daily_data.fats_grams_per_day)
        self.assertEqual(self.plan.carbs_grams, daily_data.carbs_grams_per_day)
